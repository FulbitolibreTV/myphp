...
<div class="recurso-html">
  <h2 style="font-size: 2rem; color: #1a237e; margin-bottom: 10px;">📌 HTML para Series</h2>
  
  <!-- Texto en rojo indicando fase beta -->
  <p style="color: #d32f2f; font-weight: bold; font-size: 1rem; margin-bottom: 20px;">
    ⚠️ FASE BETA
  </p>

  <p style="font-size: 1.1rem; margin-bottom: 10px;">
    Este código está diseñado para ayudarte fácilmente a colocar en sección HTML en App Creator 24.
  </p>

  <p style="color: #d32f2f; font-weight: bold;">
    Este código deves de pegarlo en sección HTML y colocar su ID de TMDB.
  </p>

  <p style="font-size: 0.95rem; margin-top: 15px;">
    Recuerda reemplazar miweb.com por tu sitio web.
  </p>


  <?php
  $ruta_archivo = 'comple/series.html';
