...
<h2 style="font-size: 2rem; color: #1a237e; margin-bottom: 20px;">📌 HTML para Login</h2>

<p style="font-size: 1.1rem; margin-bottom: 10px;">
  Este código está diseñado para tener acceso a clientes mediante pin.
</p>

<p style="color: #d32f2f; font-weight: bold;">
  Este código deves si lo quieres usar para tener control de tu contenido.</p>
</p>

<p style="font-size: 0.95rem; margin-top: 15px;">
  Recuerda reemplazar miweb.com por tu sitio web para que funcione correctamente.
</p>


  <?php
  $ruta_archivo = 'comple/loginc.html';
