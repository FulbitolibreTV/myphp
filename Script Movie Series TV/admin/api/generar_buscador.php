...
<h2 style="font-size: 2rem; color: #1a237e; margin-bottom: 20px;">📌 HTML para Buscador</h2>
...
<p style="color: #d32f2f; font-weight: bold;">
  Este código deves de pegarlo en seccion html y colocar como buscador en referencia.</p>
</p>
...
<p style="font-size: 0.95rem; margin-top: 15px;">
  ...
  <?php
  $ruta_archivo = 'comple/buscador.html';
