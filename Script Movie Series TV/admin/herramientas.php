...
<!-- Asegúrate de tener Font Awesome si no está cargado -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">

<div class="generador-container">
  <h1>
    <i class="fas fa-play-circle"></i> Generador de Video Player
  </h1>
  <p>Aquí podrás generar y probar reproductores personalizados para tus proyectos</p>

  <a href="player/index.html" class="btn-crear">
    <i class="fas fa-plus-circle"></i> Crear nuevo Player
  </a>
</div>

  </h1>
  <p>Aquí podrás tener link importantes ya sea de peliculas o de plataformas</p>

  <a href="get_enlaces.php" class="btn-crear">
    <i class="fas fa-plus-circle"></i> Ver Contenido
  </a>
</div>
